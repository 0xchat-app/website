    ...
    <div class="max-w-2xl mx-auto px-6 py-16 animate-fade-up">
      ...
      <div class="flex items-center gap-4 mb-8">
        <div class="w-16 h-16 rounded-2xl bg-gray-900 flex items-center justify-center">
          <font-awesome-icon icon="fa-brands fa-apple" class="text-white text-2xl" />
        </div>
        <div>
          <h1 class="text-3xl font-black text-gray-900 tracking-tight">iOS</h1>
          <p class="font-mono text-xs text-gray-400 mt-0.5">iPhone &amp; iPad · iOS 13.0+</p>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-3">
        ...
        >
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-xl bg-gray-100 border border-gray-100 flex items-center justify-center">
              <font-awesome-icon icon="fa-brands fa-app-store-ios" class="text-gray-700 text-xl" />
            </div>
            <div>
              <div class="font-bold text-gray-900">App Store</div>
        ...
        >
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-xl bg-gray-100 border border-gray-100 flex items-center justify-center">
              <font-awesome-icon icon="fa-solid fa-paper-plane" class="text-gray-700 text-xl" />
            </div>
            <div>
              <div class="font-bold text-gray-900">TestFlight Beta</div>
              <div class="font-mono text-xs text-gray-400">Latest features, may have bugs</div>
            </div>
          </div>
          <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-900 group-hover:translate-x-0.5 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        </a>
